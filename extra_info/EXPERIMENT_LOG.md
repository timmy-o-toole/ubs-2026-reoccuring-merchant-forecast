...
| 22 | D8 | (later removed, see row 30) Sparse per-label lean + 3,152 pseudo-labelled pretrain clients (all 3 sources agree; Salim's merged labels). Looser filters / LLM labels: no gain or worse | 0.489 (lean) | – | 0.484 | – | – | ✅ **0.513** |
